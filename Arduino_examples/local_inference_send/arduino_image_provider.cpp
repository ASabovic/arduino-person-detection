/*
This script enables the camera task in our application. Step by step, it checks if the appropriate library is correctly configured, size of temporarly buffer where the captured
